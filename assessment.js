...
function makeChatMessage(mess, author){
	var shiny = {
		message: mess,
		author: author,
		timestamp: new Date()
...
function outside(temp, hum, clouds){
	if(temp > 80 && hum > 40){
		return "I'm all sweat";
	}
	if(temp < 40 && clouds > 60){
		return "I have icecicles";
	}
	if(temp > 80 && hum < 40 && clouds < 20){
		return "I'm literally in the desert";
	}
	if(temp > 80 || hum > 50 || clouds > 50){
